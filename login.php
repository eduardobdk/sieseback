...
<head>
    ...
    <style>
        /* --- NUEVA PALETA DE COLORES OFICIALES --- */
        :root {
            --oficial-rojo: #AE192D;   /* Pantone P 53-16 C */
            --oficial-rosa: #C90166;   /* Pantone P 69-70 C */
            --oficial-verde: #009887;  /* Pantone P 131-6 C */
            --complem-beige: #D3C2B4;  /* Pantone P 23-2 C */
            --complem-negro: #000000;  /* Pantone Process Black */
        }
        ...
        * { box-sizing: border-box; }
        ...
        .login-card {
            ...
            /* Borde superior con el color principal (Rojo) */
        ...
        .system-badge {
            ...
            color: var(--oficial-rojo); /* Texto en Rojo Oficial */
            padding: 5px 12px; border-radius: 4px; font-size: 0.75rem;
            font-weight: 700; text-transform: uppercase; letter-spacing: 1px;
            border: 1px solid var(--complem-beige); /* Borde sutil en beige */
        }
        ...
        .input-label {
            ...
            color: var(--oficial-rojo); /* Etiquetas en Rojo */
        ...
        .custom-input {
            ...
            color: var(--complem-negro);
        }

        .input-icon {
            position: absolute; left: 15px; bottom: 14px;
            /* Iconos en Verde Oficial para resaltar sobre el blanco */
            color: var(--oficial-verde); 
            font-size: 1.2rem;
        }
        ...
        .custom-input:focus {
            ...
            /* Sombra suave color rojo */
            box-shadow: 0 0 0 4px rgba(174, 25, 45, 0.1); 
        }

        .btn-submit {
            width: 100%; padding: 16px;
            /* Gradiente elegante de Rojo a Rosa Oficial */
        ...
        .btn-submit:hover { 
            ...
            /* Al hacer hover, invertimos sutilmente el gradiente para efecto visual */
...
<body>
    ...
    <img src="/image/Trama_1.png" alt="Fondo" class="contenedor-fondo">

    <div class="login-card">
        <div class="card-header">
            <img src="/image/Logo Gobierno de Chiapas-05.png" alt="Gobierno de Chiapas" class="brand-logo">
            <br>
        ...
        <form action="auth.php" method="POST">
            <div class="input-group">
                ...
                <input type="text" name="usuario" class="custom-input" placeholder="ID de usuario" required>
            </div>
